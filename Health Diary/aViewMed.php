...
$sql = "SELECT * FROM medhistory WHERE id = ?";
...
<body>
    <div class="record-details">
        ...
        <div class="value"><?= htmlspecialchars($record['email']) ?></div>

        <div class="field">Doctor Name:</div>
        <div class="value"><?= htmlspecialchars($record['d_name']) ?></div>
        ...
        <a href="aMedhis.php">Back to Records</a>
    </div>
</body>
</html>

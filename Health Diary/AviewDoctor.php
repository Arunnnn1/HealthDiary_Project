...
if (isset($_GET['id'])) {
    ...
    if (!$doctor) {
        echo "<script>alert('Patient not found or unauthorized access.'); window.location='AmanageDoctor.php';</script>";
        exit();
    }
} else {
    ...
    <div class="container">
        ...
        <div class="doctor-details">
            <div class="doctor-info">
                ...
                <p><strong>Speciality:</strong> <?php echo htmlspecialchars($doctor['specialty']); ?></p>
                <p><strong>License No:</strong> <?php echo htmlspecialchars($doctor['license_number']); ?></p>
                <p><strong>Experience Years:</strong> <?php echo htmlspecialchars($doctor['experience']); ?></p>
            </div>
        </div>
